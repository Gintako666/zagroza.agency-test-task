...
export const Header = () => {
  ...
  const changeStateNav = useCallback(() => {
  ...
  return (
    <div className="container">
      <div className="header">
        ...
        <div className="header__multilinks">
          <a href="as" className="header__multilink">
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
        ...
        >
          <svg width="22" height="21" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0.78125 4.44531H21.0938C21.5252 4.44531 21.875 4.09556 21.875 3.66406V1.71094C21.875 1.27944 21.5252 0.929688 21.0938 0.929688H0.78125C0.349756 0.929688 0 1.27944 0 1.71094V3.66406C0 4.09556 0.349756 4.44531 0.78125 4.44531ZM0.78125 12.2578H15.0938C15.5252 12.2578 15.875 11.9081 15.875 11.4766V9.52344C15.875 9.09194 15.5252 8.74219 15.0938 8.74219H0.78125C0.349756 8.74219 0 9.09194 0 9.52344V11.4766C0 11.9081 0.349756 12.2578 0.78125 12.2578ZM0.78125 20.0703H21.0938C21.5252 20.0703 21.875 19.7206 21.875 19.2891V17.3359C21.875 16.9044 21.5252 16.5547 21.0938 16.5547H0.78125C0.349756 16.5547 0 16.9044 0 17.3359V19.2891C0 19.7206 0.349756 20.0703 0.78125 20.0703Z" fill="black" />
          </svg>
