    ...
    <footer className="footer">
      ...
      <div className="container">
        <div className="footer__content">
          ...
          >
            <a href="link" className="footer__nav__link">
              o que fazemos
            </a>
            <a href="link" className="footer__nav__link">
              como te ajudamos
          ...
          <div className="footer__multilinks">
            <a href="as" className="footer__multilink">
              <svg
                width="18"
                height="18"
                viewBox="0 0 18 18"
            ...
            <a href="as" className="footer__multilink">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="M9.18854 10.125L9.68846 6.86742H6.56272V4.75348C6.56272 3.86227 6.99936 2.99355 8.39928 2.99355H9.82029V0.220078C9.82029 0.220078 8.53076 0 7.29783 0C4.72369 0 3.04112 1.56023 3.04112 4.38469V6.86742H0.179749V10.125H3.04112V18H6.56272V10.125H9.18854Z" fill="white" />
              </svg>
          ...
          <div className="footer__input-group">
            <label
              htmlFor="email"
              className="footer__input-group__label"
            >
            ...
            <div>
              <input
                ...
                type="text"
                defaultValue=""
                className="footer__input-group__input"
                placeholder="nome@email.com"
              />
              <button
                type="button"
                className="footer__input-group__button"
              >
                Inscrever
